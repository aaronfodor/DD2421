...
#matrix = classifyBayes(X, prior, mu, sigma)
#print(matrix)
...
def trainBoost(base_classifier, X, labels, T=10):
    ...
    for i_iter in range(0, T):
        ...
        classifiers.append(base_classifier.trainClassifier(base_classifier, X, labels, wCur))
        ...
        for i in range(Npts):
            wCur[i] = wCur[i] * np.exp(alphaSign[i] * alpha)
